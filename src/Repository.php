...
use BlackCat\Database\Packages\DeviceCodes\Repository\DeviceCodeRepository as GeneratedRepository;
...
{
  private DeviceCodeRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof DeviceCodeRepositoryInterface) {
            throw new \InvalidArgumentException('Expected DeviceCodeRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceCodes\Dto\DeviceCodeDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceCodes\Dto\DeviceCodeDto|null { return $this->repo->getById($id, $asDto); }
