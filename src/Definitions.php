...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'device_codes'; }
    public static function contractView(): string { return 'vw_device_codes'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'device_code_hash', 'device_code_hash_key_version', 'device_code', 'device_code_key_version', 'user_code_hash', 'user_code_hash_key_version', 'client_id', 'scopes', 'token_payload', 'token_payload_key_version', 'interval_sec', 'approved_at', 'expires_at', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'device_code_hash' ], [ 'user_code_hash' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'interval_sec' ]; }
    ...
    public static function piiColumns(): array { return [ 'device_code', 'token_payload' ]; }
